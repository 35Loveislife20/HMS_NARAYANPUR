...
const getMedicineStats = async () => {
    ...
    return {
        totalMedicines:
            Number(
                rows[0].totalMedicines
            ) || 0,

        activeMedicines:
            Number(
                rows[0].activeMedicines
            ) || 0,

        lowStockMedicines:
            Number(
                rows[0].lowStockMedicines
            ) || 0,

        outOfStockMedicines:
            Number(
                rows[0].outOfStockMedicines
            ) || 0,

        expiredMedicines:
            Number(
                rows[0].expiredMedicines
            ) || 0,
    };
};
